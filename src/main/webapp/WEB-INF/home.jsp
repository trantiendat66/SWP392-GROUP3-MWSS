                            ...
                            <div class="card product-card h-100 shadow-sm">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto text-center">
                                        ...
                                        <form action="${pageContext.request.contextPath}/order/buy-now" method="post" class="d-inline buy-now-form" data-quantity="${p.quantityProduct}">
                                        ...
                                        <button class="btn btn-success btn-sm" onclick="addToCartFromHome(${p.productId}, ${p.quantityProduct})" title="Add to cart">
...
<script>
    ...
    function addToCartFromHome(productId, quantityProduct) {
